...
export const caseStudies: CaseStudy[] = [
	{
		...
		outcome:
			'Sold-out conference at Fort Mason; 15k+ builders engaged across the AIUG ecosystem, establishing it as a go-to event for the AI engineering community in SF.',
	...
	},
	{
		...
		outcome:
			'Engagement loops that outlasted the events; Multi-event series connecting product launches, developer education, and community building.',
	...
	},
	{
		...
		outcome:
			'150+ builders participated; High signal-to-noise ratio through intentional curation — technical audience, real tools, real output.',
	...
	},
	{
		...
		outcome:
			'$25k prize hackathon delivered; Strong technical participation, high-quality submissions, measurable community momentum for Intercom\'s developer ecosystem.',
	...
	},
	{
		...
		outcome:
			'15k+ builders across 80+ events; Scaled AIUG with monthly programming, 5-city tour, and 2 major SF conferences.',
	...
	},
	{
		...
		outcome:
			'60 qualified AI engineers in the room; High-trust environment generating real product feedback and ecosystem credibility for Pipelex.',
